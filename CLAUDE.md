...
- ファイルパス：`/home/user/genai-lessons/workflows/business_management_workflow_v3.json`
- プレースホルダー：YOUR_EXPENSE_LINE_TOKEN, YOUR_CLAUDE_API_KEY, YOUR_USERID_NOZOE_YU, YOUR_USERID_NOZOE_AKIKO

### 従業員・外注区分
| 稼働表の名前 | 区分 | 外注管理の業者名 | 支払ルール |
|------------|------|----------------|-----------|
| 野添優 | オーナー | - | - |
| 丸田翔吾 | 社員 | - | 給与（翌月10日）|
| 源地健史 | 社員 | - | 給与（翌月10日）|
| 服部秀一 | 外注 | **秀電工**（屋号） | 翌々月10日 |
| 井本貴史 | 外注 | 井本貴史 | 翌月末 |
| 梶原通信 | 外注 | 梶原通信 | 翌月末 |
| LLS電気 | 外注 | LLS電気 | 翌月末 |
| 株式会社トラストテクノス | 外注 | 株式会社トラストテクノス | 翌月末 |
| 株式会社RISE | 外注 | 株式会社RISE | 翌月末 |
...
### 請求書未着アラート（スケジュール予定）
- 外注（翌月末払い）: 毎月11日 → 稼働表と外注管理を照合してアラート
- 秀電工（翌々月10日払い）: 毎月21日 → 同上
- 稼働表シート名「服部秀一」→ 外注管理では「秀電工」で照合
